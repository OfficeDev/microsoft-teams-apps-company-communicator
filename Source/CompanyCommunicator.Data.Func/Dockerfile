...
WORKDIR /src
COPY ["Microsoft.Teams.Apps.CompanyCommunicator.Data.Func/Microsoft.Teams.Apps.CompanyCommunicator.Data.Func.csproj", "Microsoft.Teams.Apps.CompanyCommunicator.Data.Func/"]
...
RUN dotnet restore "Microsoft.Teams.Apps.CompanyCommunicator.Data.Func/Microsoft.Teams.Apps.CompanyCommunicator.Data.Func.csproj"
COPY . .
WORKDIR "/src/Microsoft.Teams.Apps.CompanyCommunicator.Data.Func"
RUN dotnet build "Microsoft.Teams.Apps.CompanyCommunicator.Data.Func.csproj" -c Release -o /app/build

FROM build AS publish
RUN dotnet publish "Microsoft.Teams.Apps.CompanyCommunicator.Data.Func.csproj" -c Release -o /app/publish
