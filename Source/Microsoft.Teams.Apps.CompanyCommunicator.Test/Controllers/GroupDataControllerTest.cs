...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Test.Controllers
{
    ...
    public class GroupDataControllerTest
    {
        ...
        {
            // Arrange
            Action action = () => new GroupDataController(notificationDataRepository.Object, groupsService.Object);
        ...
        {
            // Arrange
            Action action1 = () => new GroupDataController(null /*notificationDataRepository*/, groupsService.Object);
            Action action2 = () => new GroupDataController(notificationDataRepository.Object, null /*groupsService*/);
        ...
        {
            // Arrange
            var controller = GetGroupDataControllerInstance();
        ...
        public async Task GetGroupData_WithQueryLength3_ReturnsNull()
        {
            ...
            groupsService.Setup(x => x.SearchAsync(It.IsAny<string>())).ReturnsAsync(groupList);
        ...
        public async Task Get_CallGroupSerarchService_ShouldInvokeOnce()
        {
            ...
            groupsService.Setup(x => x.SearchAsync(It.IsAny<string>())).ReturnsAsync(group);

            // Act
            var result = await controller.SearchAsync(query);

            // Assert
            groupsService.Verify(x => x.SearchAsync(It.IsAny<string>()), Times.Once);
        }
        ...
        public async Task Get_GroupSearchServiceById_ReturnsOkObjectResult()
        {
            ...
            groupsService.Setup(x => x.GetByIdsAsync(It.IsAny<IEnumerable<string>>())).Returns(group.ToAsyncEnumerable());
        ...
        {
            return new GroupDataController(notificationDataRepository.Object, groupsService.Object);
        }
    }
}
