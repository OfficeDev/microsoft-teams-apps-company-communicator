// <copyright file="SendQueueSubOrchestrator.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Prep.Func.PreparingToSend.Orchestrators
{
    ...
    /// </summary>
    public static class SendQueueSubOrchestrator
    {
        /// <summary>
        ...
        [FunctionName(FunctionNames.SendQueueSubOrchestrator)]
            ...
            ILogger log)
        {
            ...
            {
                log.LogInformation("About to get recipients.");
            }
            ...
            var batches = recipients.ToList().SeparateIntoBatches(SendQueue.MaxNumberOfMessagesInBatchRequest);
