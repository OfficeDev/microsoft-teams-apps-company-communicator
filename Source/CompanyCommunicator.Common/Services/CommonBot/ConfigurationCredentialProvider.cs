...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Services.CommonBot
{
    ...
    public class ConfigurationCredentialProvider : ServiceClientCredentialsFactory
    {
        ...
        /// </summary>
        /// <returns>A task that represents the work queued to execute.</returns>
        /// <remarks>If the task is successful and bot authentication is disabled, the result is true;
        /// otherwise, false.This method is async to enable custom implementations that need to call out
        /// to serviced to validate the appId / password pair.
        /// </remarks>
